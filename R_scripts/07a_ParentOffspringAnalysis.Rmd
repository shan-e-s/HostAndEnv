...
```{r}
offspring.female.shannon <- lmer(nst.shannon ~ fe.shannon*ageBinned + (1|site/nest/bird.ID), data = nstlng.adult.df)
summary(arm::standardize(offspring.female.shannon))
```

### chao
```{r}
offspring.female.chao <- lmer(nst.chao1 ~ fe.chao1*ageBinned + (1|site/nest/bird.ID), data = nstlng.adult.df)
...
offspring.female.proteo <- glmer(binomial.response ~  fe.pro.abu.RA*ageBinned + (1|site/nest/bird.ID), family= binomial, weights = nst.NumberOfReads, data = nstlng.adult.df)
...
offspring.female.firmic <- glmer(binomial.response ~  fe.fir.abu.RA*ageBinned + (1|site/nest/bird.ID), family= binomial, weights = nst.NumberOfReads, data = nstlng.adult.df)
...
offspring.male.proteo <- glmer(binomial.response ~  m.pro.abu.RA*ageBinned + (1|site/nest/bird.ID), family= binomial, weights = nst.NumberOfReads, data = nstlng.adult.df)
...
offspring.male.firmic <- glmer(binomial.response ~  m.fir.abu.RA*ageBinned + (1|site/nest/bird.ID), family= binomial, weights = nst.NumberOfReads, data = nstlng.adult.df)
