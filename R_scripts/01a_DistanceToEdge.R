...
# note: Ivan said some polygons not accurate, simply rough boxes around sites, use archived google earth images to update?

#rm(list=ls())

# set directory
#setwd("/Users/shane/Desktop/GTM_phd/R_microbiome_PhD/R_scripts_gtm")
