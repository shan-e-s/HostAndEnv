...
layDate.proteo.adult<-effect_plot(top.adult.proteo, pred=z.layDateFirst, x.label="Lay date", y.label="Proteobacteria (relative abundance)", interval =TRUE, int.type = "confidence", partial.residuals = TRUE, jitter = 0.01, point.alpha = 0.2, point.size = 0.75) +ylim(0,1)
...
layDate.firmic.adult<-effect_plot(top.adult.firmic, pred=z.layDateFirst, x.label="Lay date", y.label="Firmicutes (relative abundance)", interval =TRUE, int.type = "confidence", partial.residuals = TRUE, jitter = 0.01, point.alpha = 0.2, point.size = 0.75) + ylim(0,1)
...
```{r}
p1 <- plot_grid(layDate.proteo.adult+theme_classic2()+ylab(NULL)+labs(title="Proteobacteria"), layDate.firmic.adult+theme_classic2()+ylab(NULL)+labs(title="Firmicutes"), labels = c("A", "B")) 
