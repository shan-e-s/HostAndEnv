...
p5 <- cowplot::plot_grid(p3.grid, p4.grid, nrow = 2,  rel_heights = c(1,3))
p5
```

```{r}
ggsave("Fig4_RA_allBirds_combined.tiff", plot = p5, device = "tiff", path = "../R_figures", width = 20, height = 20, units = "cm", dpi = 200)
```
